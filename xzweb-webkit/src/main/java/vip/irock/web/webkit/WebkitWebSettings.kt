...
class WebkitWebSettings(val webSettingsProxy: WebSettings) :
    IWebSettings {
    ...
    override fun getAllowUniversalAccessFromFileURLs(): Boolean {
        return webSettingsProxy.allowUniversalAccessFromFileURLs
    }
...
//    }
    ...
    override fun setAllowUniversalAccessFromFileURLs(var1: Boolean) {
        webSettingsProxy.allowUniversalAccessFromFileURLs = var1
    }

    override fun setAllowFileAccessFromFileURLs(var1: Boolean) {
        webSettingsProxy.allowFileAccessFromFileURLs = var1
    }
